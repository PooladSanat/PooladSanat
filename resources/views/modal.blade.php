                                        ...
                                        <div class="nav-tabs-custom">
                                            <ul class="nav nav-tabs" style="background-color: rgba(0,105,255,0.07)">
                                                <li class="active" style="width: 25%;"><a href="#a" data-toggle="tab">اطلاعات
                                                        پایه</a></li>
                                                <li style="width: 25%;"><a href="#b" data-toggle="tab">لیست تراکنش ها</a></li>
                                                <li style="width: 25%;"><a href="#c" data-toggle="tab">سوابق خرید</a></li>
                                                <li style="width: 23.4%;"><a href="#d" data-toggle="tab">اسناد پرداختی</a></li>
                                            </ul>
                                            <div class="tab-content">
                                                <div class="active tab-pane" id="a">
                                                    <br/>
                                                    <table class="table table-striped table-bordered information" id="information">
                                                ...
                                                <div class="tab-pane" id="b">
                                                    <br/>
                                                    <table class="table table-striped table-bordered traconesh" id="traconesh">
                                                        <thead style="background-color: #e8ecff">
                                                        <tr>
                                                ...
                                                <div class="tab-pane" id="c">
                                                    <br/>
                                                    <table class="table table-striped table-bordered kharid" id="kharid">
                                                        <thead style="background-color: #e8ecff">
                                                        <tr>
                                                            <th style="width: 1%">ردیف</th>
                                                            <th>تاریخ</th>
