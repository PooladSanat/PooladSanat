        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-8">
                    ...
                    <br/>
                    <strong> به : {{$customer_name->name}}</strong>
                    <br/>
            ...
            <table>
                ...
                <tfoot>
                <tr>
                    <th colspan="3">جمع فاکتور</th>
                    <th>{{number_format($sum_price)}}</th>
                </tr>
                <tr>
                    <th colspan="3">تخفیف</th>
                    <th>{{number_format($takhfif)}}</th>
                </tr>
                <tr>
                    <th colspan="3">مبلغ قابل پرداخت</th>
                    <th>{{number_format($final)}}</th>
                </tr>
                <tr>
                    <th colspan="3">جمع اسناد پرداختی</th>
                    <th>{{number_format($price_customer)}}</th>
                </tr>
                <tr>
                    <th colspan="3">مانده حساب مشتری</th>
                    <th>{{number_format($customeraccount)}}</th>
                </tr>
