...
<script type="text/javascript">
    $(function () {
        ...
        var table = $('.data-table').DataTable({
            ...
            ajax: "{{ route('admin.pmmachine.list') }}",
            columns: [
        ...
        $('body').on('click', '.editProduct', function () {
            ...
            $.get("{{ route('admin.pmmachine.update') }}" + '/' + product_id, function (data) {
                $('#ajaxModel').modal('show');
        ...
        $('#saveBtn').click(function (e) {
            ...
            $.ajax({
                ...
                url: "{{ route('admin.pmmachine.store') }}",
                type: "POST",
                dataType: 'json',
    ...
    $('body').on('click', '.deleteProduct', function () {
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: 'DELETE',
                    url: "{{route('admin.pmmachine.delete')}}" + '/' + id,
                    data: {
