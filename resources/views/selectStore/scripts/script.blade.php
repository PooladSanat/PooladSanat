    ...
    $(function () {
        ...
        $('#saveBtn').click(function (e) {
            ...
            $.ajax({
                ...
                url: "{{ route('admin.selectstore.store') }}",
                type: "POST",
                dataType: 'json',
                success: function (data) {
                    ...
                    if (data.success) {
                        ...
                        Swal.fire({
                            title: 'موفق',
                            text: 'مشخصات انبار با موفقیت در سیستم ثبت شد',
                            icon: 'success',
                            confirmButtonText: 'تایید',
                        });
                    }
    ...
    $('body').on('click', '.deleteProduct', function () {
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: 'DELETE',
                    url: "{{route('admin.selectstore.delete')}}" + '/' + id,
                    data: {
                    ...
                    success: function (data) {
                        ...
                        Swal.fire({
                            title: 'موفق',
                            text: 'مشخصات انبار با موفقیت از سیستم حذف شد',
                            icon: 'success',
                            confirmButtonText: 'تایید'
                        })
                    }
