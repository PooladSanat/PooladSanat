...
<div class="container-fluid">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-8">
                <br/>
                <strong>از : شرکت ماشین های تزریق پلاستیک پولاد</strong>
                <br/>
        ...
        <p>احتراما، بدینوسیله پیش فاکتور اقلام مورد نیاز آن شرکت جهت بررسی تقدیم حضور می گردد. خواهشمند است در صورت
            تایید ذیل این برگه را مهر و امضا نموده به شماره 77327573 داخلی 270 نمابر نمایید.</p>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <p style="font-size: 10px">تلفن:02177333337&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;www.pooladimm.com&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;کد
                        پستی:1658614511</p>
                    <p style="font-size: 10px">تلفن:02177963331&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;info@pooladimm.com&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;صندوق
                        پستی:16895111</p>
                </div>
            </div>
        </div>
